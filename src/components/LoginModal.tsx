...
import { X, Hotel, Plane, Ship, Loader2, MapPin, CreditCard } from 'lucide-react';
  ...
  const slides = [
    {
      ...
      subtitle: 'AI-powered travel planning from discussion to booking - all in one chat.',
      icon: MapPin,
      color: 'from-blue-400 to-cyan-400'
    },
    {
      title: 'Discover Perfect Destinations!',
      subtitle: 'Get personalized recommendations for hotels, resorts & accommodations.',
      icon: Hotel,
    ...
    },
    {
      ...
      subtitle: 'Seamless booking for flights, hotels, transfers & experiences.',
      icon: Ship,
            ...
            >
              {isSubmitting || isLoading ? (
                ...
                <>
                  ...
                  <span className="text-gray-800 font-semibold text-base">Continue with Google</span>
                </>
              )}
            </button>

            <p className="text-xs text-gray-500 text-center leading-relaxed">
              By continuing, you agree to EaseMyTrip's{' '}
              <a href="#" className="text-blue-600 hover:text-blue-700 font-semibold hover:underline">Terms of Service</a>
              {' '}and{' '}
